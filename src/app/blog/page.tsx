    ...
    <>
      ...
      <main className="flex-grow overflow-hidden bg-[#fbf8f1]">
        <header className="relative border-b border-stone-200/80 bg-slate-950 text-white">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 sm:py-28 lg:grid-cols-[1fr_0.65fr] lg:items-end lg:px-8">
            <div>
              ...
              <h1 className="mt-6 max-w-4xl font-display text-5xl font-black leading-[0.98] tracking-tight sm:text-7xl">
            ...
            <div className="border-l border-white/15 pl-6 sm:pl-8">
              ...
              <div className="mt-6 flex flex-wrap gap-5 text-xs font-bold uppercase tracking-[0.14em] text-slate-400">
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8" aria-label="Article à la une">
          ...
          <article className="group relative grid overflow-hidden rounded-[1.75rem] bg-slate-950 shadow-[0_24px_70px_rgba(15,23,42,0.18)] lg:grid-cols-[1.25fr_0.75fr]">
            ...
            <div className="relative flex flex-col justify-center p-7 text-white sm:p-10 lg:p-12">
              ...
              <h2 className="mt-5 font-display text-3xl font-black leading-tight sm:text-4xl">{featuredPost.title}</h2>
              <p className="mt-5 leading-7 text-slate-300">{featuredPost.excerpt}</p>
              <Link href={`/blog/${featuredPost.slug}`} className="mt-8 inline-flex w-fit items-center gap-3 rounded-full bg-orange-600 px-6 py-3.5 text-sm font-extrabold text-white transition hover:bg-orange-500 after:absolute after:inset-0">
            ...
            {otherPosts.map((post) => (
              <article key={post.slug} className="group relative flex h-full flex-col">
                ...
                <div className="flex flex-1 flex-col pt-5">
                  ...
                  <h3 className="mt-3 font-display text-2xl font-black leading-tight text-slate-950 transition group-hover:text-orange-700">{post.title}</h3>
